...
def generate_image(
    ...
    **kwargs
    ...
    # 规范尺寸
    drawer.IMAGE_WIDTH = 296
    drawer.IMAGE_HEIGHT = 128
    ...
    img, _ = create_custom_canvas(296, 128, palette_type='bw', cmode=cmode)
    img_drawn = drawer.draw_weather(weather_data)
    return finalize_image_common(img_drawn, rotate=rotate, invert=invert)
