...
def generate_image(rotate=0, invert=False, tz=None, cmode=None, **kwargs):
    ...
    draw.text((16, 10), str(data['meta']['title']), fill=2, font=title_font)
    draw.text((16, 44), str(data['meta']['subtitle']), fill=1, font=body_font)
    ...
    draw_rows(draw, 16, 72, rows, body_font, body_font)
