...
def generate_image(rotate=0, invert=False, tz=None, cmode=None, **kwargs):
    ...
    draw_safe_text(draw, (16, 48), str(data['meta']['subtitle']), fill=1, font=body_font, img_width=img.width, img_height=img.height)
    ...
    draw_rows(draw, 16, 84, rows, body_font, body_font, img.width, img.height, row_gap=10)
